...
export RAY_TMPDIR=/data/Agent/ray_tmp
...
# Set Python path
export PYTHONPATH="/home/wangxucong.wxc/AERPO/ARPO/verl_arpo_entropy":$PYTHONPATH

# ============================ Model Configuration ============================
# Actor model path
ACTOR_MODEL_PATH="/data/Agent/models/Llama-3.1-8B-Instruct" # Modify training model path
...
EXPERIMENT_NAME="ARPO_global_16_init_8_beam_2_random_0_arpo_0.2_entropy_${LASTING}_04151749" # Modify experiment name

# Configuration file path
CONFIG_PATH="/home/wangxucong.wxc/AERPO/ARPO/scripts/config" # Modify the absolute path of the config folder, relative path is not recommended
CONFIG_NAME="ppo_trainer.yaml"

# Distributed training settings
NNODES=1                            
N_GPUS_PER_NODE=8                   # 6 GPUs available (skip GPU 3 and 7)
...
# Data file paths
TRAIN_FILES="/home/wangxucong.wxc/AERPO/ARPO/rl_datasets/train_10k.parquet" # Modify training data path
VALID_FILES="/home/wangxucong.wxc/AERPO/ARPO/rl_datasets/valid.parquet" # Modify validation data path
...
Entropy_weight=0.2
ENABLE_MULTI_TURN=True             # Enable multi-turn rollout with tool support
# ============================ Rollout Tools Configuration ==========================
SEARCH_CACHE_PATH="/home/wangxucong.wxc/AERPO/ARPO/search_cache/search_cache.json" # Modify
TOOL_CONFIG_PATH="/home/wangxucong.wxc/AERPO/ARPO/search_cache/search_cache.json" # tool_config_path placeholder (actual tool config is in ppo_trainer.yaml)

# ============================ Reward Model Configuration ==========================
# Reward model settings
REWARD_MANAGER="naive"              # Reward manager type
CUSTOM_REWARD_FUNCTION_PATH="/home/wangxucong.wxc/AERPO/ARPO/verl_arpo_entropy/verl/utils/reward_score/deep_research.py" # Modify reward function path
...
TEST_FREQ=1                        # Test frequency

# ============================ Path Configuration ============================
# Save path
SAVE_PATH="/data/Agent/logs/ckpt_savedir/${EXPERIMENT_NAME}" # Modify save path
ROLLOUT_SAVE_PATH="${SAVE_PATH}/rollout"
rm -rf $SAVE_PATH

# ============================ WandB Configuration ============================
# WandB settings
WANDB_API_KEY="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" # Modify your wandb key

export WANDB_MODE=offline
export WANDB_DIR="/home/wangxucong.wxc/wandb"
